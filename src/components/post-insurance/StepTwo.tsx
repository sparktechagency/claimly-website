    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 pr-12 py-3 border rounded-[12px] outline-none text-[#64748B] bg-white transition-all ${
              errors.incidentDate ? "border-red-500" : "border-[#DBEAFE]"
            }`}
          />
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 pr-12 py-3 border rounded-[12px] outline-none text-[#64748B] bg-white transition-all ${
              errors.reportDate ? "border-red-500" : "border-[#DBEAFE]"
            }`}
          />
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="What happened, where it occurred, who was involved..."
          className={`w-full px-4 py-3 border rounded-[12px] outline-none text-[#64748B] bg-white min-h-[120px] ${
